...
<div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      {
        query("UPDATE tbl_category set `deleted_flag` = 1 where id = $id");
        return message_success("Category Deleted Successfully!");
      }
      ?>
      ...
      <div class="container-fluid" id="content">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0"><i class="fa fa-tag"></i> Categories</h1>
          </div><!-- /.col -->
          <div class="col-sm-12">
            <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
              ...
              <tbody>
                ...
                <?php foreach (get_list("select * from tbl_category where deleted_flag = 0 $where ") as $res) { ?>
                  <tr>
                    ...
                    <?php } else { ?>
                      <td>
                        <a href="view_category.php?id=<?= $res['id']; ?>" class="btn btn-sm btn-dark"> View <i class="fa fa-eye"></i> </a>
                      </td>
                    <?php } ?>
                  </tr>
                <?php } ?>
