    ...
    <div class="signup-col">
      ...
      <form method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate id="myForm">
        ...
        <div class="col-md-3">
          ...
          <input type="text" class="form-control <?= isset($_SESSION['error']['middle_name']) ? 'is-invalid' : '' ?>" name="middle_name" required value="<?= isset($_POST['middle_name']) ? $_POST['middle_name'] : '' ?>">
          <div class="invalid-feedback">
