  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <div class="container-fluid" id="content">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0"><i class="fa fa-edit"></i> Edit Client
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          ...
                          <div style="display: flex;">
                            <select id="province" name="province" style="width:100%" class="form-control <?= isset($_SESSION['error']['province']) ? 'is-invalid' : '' ?>">
                      ...
                      <div class="col-sm-3">
                        ...
                        <div class="form-group">
                          <label>*Email</label>
                          <input type="email" pattern="^[a-zA-Z0-9]+@gmail\.com$" class="form-control <?= isset($_SESSION['error']['email']) ? 'is-invalid' : '' ?>" id="email" name="email" placeholder="Email" value="<?= isset($_POST['email']) ? $_POST['email'] : $user->email ?>" required title="This field should be xxx@gmail.com">
                        </div>
                        <div class="form-group">
