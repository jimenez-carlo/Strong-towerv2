      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            ...
            <a href="#" class="d-block"><?= ucfirst($_SESSION['user']->first_name) . ' ' . ucfirst($_SESSION['user']->last_name); ?><br><?= ucfirst($_SESSION['user']->access ?? 'Customer')  ?><?= $_SESSION['user']->access_id == 1 ? '' : (
                                                                                                                                                                                                  (strlen(get_access($_SESSION['user']->branch_id ?? 0)) > 19) ?
                                                                                                                                                                                                  '<br><marquee> ' . get_access($_SESSION['user']->branch_id ?? 0) . '</marquee>' :
                                                                                                                                                                                                  '<br>' . get_access($_SESSION['user']->branch_id ?? 0)
                                                                                                                                                                                                ); ?></a>
          </div>
        </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php switch ($_SESSION['user']->access_id) {
              case 1: ?>
                ...
                <li class="nav-item"><a href="category.php" class="nav-link <?= activate(array("category", "create_category", "edit_category")) ?>"><i class="fa fa-tags nav-icon"></i>
                    <p>Categories</p>
                  </a></li>
                <li class="nav-item"><a href="body_part.php" class="nav-link <?= activate(array("body_part", "create_body_part", "edit_body_part")) ?>"><i class="fa fa-hand nav-icon"></i>
                    <p>Body Part</p>
                  </a></li>
              ...
              case 5: ?>
                ...
                <li class="nav-item"><a href="category.php" class="nav-link <?= activate(array("category", "create_category", "edit_category", "view_category")) ?>"><i class="fa fa-hand nav-icon"></i>
                    <p>Categories</p>
                  </a></li>
