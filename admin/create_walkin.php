...
<div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      {
        extract($data);
        $required_fields = array('first_name', 'last_name', 'contact', 'price');
        $errors = 0;
        ...
        $id = $_SESSION['user']->id;
        query("INSERT INTO tbl_walkin (`first_name`,`middle_name`,`last_name`,`price`,`contact_no`,`created_by`) VALUES('$first_name', '$middle_name','$last_name','$price','$contact','$id')");
        unset($_POST);
      ...
      <div class="container-fluid" id="content">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0"><i class="fa fa-user-plus"></i> Add Walkin</h1>
          </div><!-- /.col -->
        </div>
